...
class ExamController extends Controller
{
    ...
    public function userQuizResult($userId,$quizId){
        ...
        return view('backend.result.result', compact('results', 'totalQuestions', 'attemptQuestion', 'userCorrectAnswer', 'userWrongAnswer', 'percentage', 'quiz'));
    }
